...
NDiplomacy = {
	...
	IMPERIAL_AUTHORITY_FROM_PRINCES = 0.17,			-- Scales to threshold
	HRE_FOREIGN_CONTROL_PENALTY = -0.02,			-- Each foreign-controlled province in the empire (owned or vassalised) lowers IA by this amount
...
NCountry = {
	...
	SEND_OFFICERS_MAINTENANCE_MULTIPLIER = 0.66,
...
NMilitary = {
	...
	BASE_MP_TO_MANPOWER = 0.3,		-- 250 men per manpower
	SIEGE_ATTRITION = 1,
	...
	UNLOAD_COST_ENEMY = 20,							-- cost to hostile.
