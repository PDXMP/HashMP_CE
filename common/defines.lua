...
NCountry = {
	...
	HRE_INCIDENT_ELECTOR_SUPPORT_IA = 0.1,	-- How much worth an elector support is in an incident
	HRE_INCIDENT_MEMBER_SUPPORT_IA = 0.1,	-- How much worth an elector support is in an incident
