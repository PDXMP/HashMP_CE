...
NDiplomacy = {
	...
	HRE_FOREIGN_CONTROL_PENALTY = -0.03,			-- Each foreign-controlled province in the empire (owned or vassalised) lowers IA by this amount
...
NEconomy = {
	...
	INFLATION_FROM_LOAN = 0.20,						-- increase per loan
