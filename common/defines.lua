...
NEconomy = {
	...
	GOLD_MINE_DEPLETION_THRESHOLD = 8,				-- Gold mines above production level or above can be depleted
	GOLD_MINE_DEPLETION_CHANCE = 0.6,					-- Chance of gold mine being depleted (yearly, per production above threshold)
