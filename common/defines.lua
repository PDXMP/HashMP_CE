...
NDiplomacy = {
	...
	DEFENDER_OF_FAITH_PENALTY_DAYS = 0,			-- Duration of the modifier applied to a defender of the faith that refuses to defend a nation with the same religion
	...
	TRIBUTE_BASE_MANPOWER = 0.05,					-- Tributary State: Part of yearly manpower given in tribute
...
NCountry = {
	...
	CONCENTRATE_DEVELOPMENT_DEVELOPMENT_DECREASE = 0,
...
NMilitary = {
	...
	TRANSPORT_TIME = 245, 							-- _MDEF_TRANSPORT_TIME = 10,
	...
	TRADITION_GAIN_LAND = 35,						-- Tradition gain base value from land combat.
	TRADITION_GAIN_NAVAL = 60,						-- Tradition gain base value from naval combat.
	...
	DEFAULT_WARGOAL_WARSCORE_BONUS	= 8,			-- Warscore bonus
	DEFAULT_WARGOAL_BATTLESCORE_BONUS = 8,		-- Battle score bonus from winning battles
	...
	CAV_SUPPRESSION = 1.0,						-- The amount of reduction to unrest for each friendly cavalry regiment in a province
...
NReligion = {
	...
	YEARLY_PAPAL_INFLUENCE_PER_CARDINAL = 0.3,					-- The amount of yearly papal influence you receive each year for each cardinal you have active
	...
	APPOINT_CARDINAL_INFLUENCE = 0.0,						-- Invested Influence given by appointing a cardinal
	APPOINT_CARDINAL_CORRUPTION = 0.5,						-- Corruption gained by the Papal State when appointing cardinals in its own land
	APPOINT_CARDINAL_INFLUENCE_PAPAL_STATE = 0.0,			-- Yearly passive influence gained by cardinals in Papal States
