...
NGame = {
	...
	DAYS_BEHIND_PAUSE = 45,					-- In multiplayer, if the slowest player is lagging behind this amount of days, the game will pause
...
NMilitary = {
	...
	BANNER_STARTING_STRENGTH = 1.0, -- being full strength
